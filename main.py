...
• BY : @ASAKIOP
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                [
                                        ...
                                        InlineKeyboardButton('• DEV', url='https://T.ME/ASAKIOP')
                                    ],]
                            ),        
...
<b>• ‍🔧 المطور:</b> <a href="https://t.me/ASAKIOP">اضغط هنا</a>

<b>• 📚 المكتبة:</b> <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>

<b>• 📢 قناة السورس:</b> @Mlze1bot

<b>• 🌀 ملفات السورس:</b> <a href="https://t.me/Mlze1bot">اضغط هنا</a>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "🔙 رجـوع", callback_data="help"),
                                        InlineKeyboardButton(
                                            "المطـور ⛓️️", url="https://t.me/ASAKIOP"),
                                  ],]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="▾∮ تم حظرك من استخدام البوت تواصل مع مطوري [اضغط هنا](https://t.me/ASAKIOP).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("قناة السورس", url=f"https://t.me/Mlze1bot")
                        ]
                    ]
                ),
                parse_mode="markdown"
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="هنالك شي خطا تواصل مع مطوري [اضغط هنة](https://t.me/ASAKIOP).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
